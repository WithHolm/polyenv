...
func SaveVault(v Vault, dotenvFile string) error {
	...
	template = append(template, "# this file is automatically generated by dotenv-myvault")
	template = append(template, "# do not edit this file (unless you know what you are doing)")
	...
	template = append(template, "# see https://github.com/withholm/dotenv-myvault for more info on the options available")
